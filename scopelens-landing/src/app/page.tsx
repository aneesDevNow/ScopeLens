      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-slate-100">
        <div className="container mx-auto flex h-20 items-center justify-between px-6">
          ...
          <div className="hidden md:flex items-center gap-8">
            <Link href="#features" className="text-sm font-medium text-slate-500 hover:text-slate-700 transition-colors">Features</Link>
            <Link href="#pricing" className="text-sm font-medium text-slate-500 hover:text-slate-700 transition-colors">Pricing</Link>
            <Link href="/reseller" className="text-sm font-medium text-slate-500 hover:text-slate-700 transition-colors">Resellers</Link>
          </div>
        ...
        <div className="container mx-auto px-6 py-24 lg:py-32 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-white text-slate-600 font-semibold rounded-xl border-2 border-slate-200 hover:border-slate-300 hover:bg-slate-50 transition-all text-lg">
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-white">ScopeLens</span>
            </div>
            <div className="flex gap-8 text-sm">
              ...
              <Link href="/reseller" className="text-slate-400 hover:text-white transition-colors">Resellers</Link>
            </div>
            <p className="text-sm text-slate-500">© 2026 ScopeLens. All rights reserved.</p>
          </div>
        </div>
      </footer >
    </div >
